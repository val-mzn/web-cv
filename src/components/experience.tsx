  ...
  return (
    <Section id="experience" className="bg-slate-800">
      ...
      <div className="relative">
        {/* Timeline verticale */}
        <div className="absolute left-27 top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-500 via-teal-500 to-indigo-500 opacity-30"></div>
        
        <div className="flex flex-col gap-12">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="relative grid grid-cols-5 gap-8 group justify-center items-center"
            >
